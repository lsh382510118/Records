...
class Register extends Component {
	...
	// 确定注册
	confirmRegister = (e) => {
		const { mobile, code, nickName, wechat, password, repassword } =
			this.state;

		if (
			this.vertifyMobile(mobile) &&
			this.vertifyEmpty(null, 'code', 'allowCode') &&
			this.vertifyEmpty(null, 'nickName', 'allowName') &&
			this.vertifyEmpty(null, 'wechat', 'allowWechat') &&
			this.vertifyPassword(password) &&
		...
		return (
			<div className="register">
				...
				<div
					...
					style={{
						backgroundImage:
							'url(http://localhost:3000/images/bk.jpg)',
					}}
				></div>
					...
					<Form onSubmit={this.handleSubmit}>
						...
						<FormItem {...formItemLayout} label="手机">
							<Input
								...
								onChange={(e) => this.vertifyMobile(e)}
							/>

							{!allowMobile ? (
								<p className="error-tip">请输入正确的手机号</p>
							) : null}
						</FormItem>
						...
						>
							...
							/>
							{!allowName ? (
								<p className="error-tip">请输入您的昵称</p>
							) : null}
						</FormItem>
						...
						<FormItem {...formItemLayout} label="密码">
							<Input
								...
								onChange={(e) => this.vertifyPassword(e)}
							/>
							{!allowPassword ? (
								<p className="error-tip">
									请输入至少6位数的密码
						...
						<FormItem {...formItemLayout} label="确认密码">
							<Input
								...
								onChange={(e) => this.vertifyRepassword(e)}
							/>
							{!allowRepassword ? (
								<p className="error-tip">两次密码不一致</p>
							) : null}
						</FormItem>
